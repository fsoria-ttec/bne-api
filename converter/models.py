...
query_create_grp = '''
CREATE VIRTUAL TABLE IF NOT EXISTS grp USING FTS5(
        id,
        t_001,
        id_symphony,
        t_935,
...
query_create_cog = '''
CREATE VIRTUAL TABLE IF NOT EXISTS cog USING FTS5(
        id,
        t_001,
        id_symphony,
        t_935,
...
query_create_gen = '''
CREATE VIRTUAL TABLE IF NOT EXISTS gen USING FTS5(
        id,
        t_001,
        id_symphony,
        t_935,
...
query_create_kit = '''
CREATE VIRTUAL TABLE IF NOT EXISTS kit USING FTS5(
        id,
        t_001,
        id_symphony,
        t_935,
...
query_create_mam = '''
CREATE VIRTUAL TABLE IF NOT EXISTS mam USING FTS5(
        id,
        t_001,
        id_symphony,
        t_935,
...
query_create_mat = '''
CREATE VIRTUAL TABLE IF NOT EXISTS mat USING FTS5(
        id,
        t_001,
        id_symphony,
        t_935,
...
query_create_tit = '''
CREATE VIRTUAL TABLE IF NOT EXISTS tit USING FTS5(
        id,
        t_001,
        id_symphony,
        t_935,
...
create_statements = {
    ...
    "grp": query_create_grp,
    "queries": query_create_queries,
    "map": query_create_map,
    "cog": query_create_cog,
    "gen": query_create_gen,
    "kit": query_create_kit,
    "mam": query_create_mam,
    "mat": query_create_mat,
    "tit": query_create_tit
}
