...
def print_current_config():
    ...
    # Rendimiento
    print(color_text("1. Configuración de rendimiento:", Fore.GREEN + Style.BRIGHT))
    ...
    # CKAN
    print(color_text("3. Configuración CKAN:", Fore.GREEN + Style.BRIGHT))
    ...
    print(color_text("0. Volver al menú principal", Fore.YELLOW))
    print()
...
def configure_performance():
    ...
    print(color_text("Configuración actual:", Fore.CYAN))
    print(f"1. Tamaño de lote: {BATCH_SIZE}")
    print(f"2. Descargas concurrentes: {CONCURRENT_DOWNLOADS}")
    print("0. Volver")
    print()
    
    option = input(color_text("Seleccione una opción: ", Fore.GREEN))
...
def configure_export_formats():
    ...
    print(color_text("Formatos disponibles:", Fore.CYAN))
    ...
    try:
        option = int(input(color_text("Seleccione un formato para cambiar su estado: ", Fore.GREEN)))
        ...
        if 1 <= option <= len(formats):
            ...
            CONFIG["export_formats"][format_name]["enabled"] = not current_state
            
            # Guardar cambios
            save_config(CONFIG)
            
            new_state = "activado" if not current_state else "desactivado"
            print(color_text(f"\n✓ Formato {format_name} {new_state} correctamente", Fore.GREEN))
...
def main_menu():
    ...
    while True:
        ...
        print(color_text("Seleccione una opción:", Fore.CYAN))
        print("1. Configurar rendimiento")
        print("2. Configurar formatos de exportación")
        print("3. Configurar CKAN")
        print("0. Salir")
        print()
        
        option = input(color_text("Opción: ", Fore.GREEN))
